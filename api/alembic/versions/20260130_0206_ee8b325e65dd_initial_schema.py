...
def upgrade() -> None:
    ...
    op.create_table('asceticism_packages',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('type', sa.Enum('BOOLEAN', 'NUMERIC', 'TEXT', name='trackingtype'), nullable=False),
    sa.Column('custom_metadata', sa.JSON(), nullable=True),
    sa.Column('createdAt', sa.DateTime(), nullable=False),
    sa.Column('updatedAt', sa.DateTime(), nullable=False),
    ...
    sa.Column('role', sa.Enum('MEMBER', 'ADMIN', 'MENTOR', name='grouprole'), nullable=False),
    sa.Column('custom_metadata', sa.JSON(), nullable=True),
    ...
    sa.Column('custom_metadata', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['programId'], ['Program.id'], ),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('providerAccountId', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    ...
    op.create_table('daily_reading_notes',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('date', sa.DateTime(), nullable=False),
    ...
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('expires', sa.DateTime(), nullable=False),
    sa.Column('sessionToken', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('sessionToken')
    )
    op.create_table('ProgramItem',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('programId', sa.Integer(), nullable=False),
    ...
    sa.Column('custom_metadata', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['asceticismId'], ['Asceticism.id'], ),
    sa.ForeignKeyConstraint(['programId'], ['Program.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('UserAsceticism',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('asceticismId', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'PAUSED', 'COMPLETED', 'ARCHIVED', name='asceticismstatus'), nullable=False),
    sa.Column('startDate', sa.DateTime(), nullable=False),
    ...
    sa.Column('createdAt', sa.DateTime(), nullable=False),
    sa.Column('updatedAt', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['asceticismId'], ['Asceticism.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['userId'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('custom_metadata', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['asceticismId'], ['Asceticism.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['packageId'], ['asceticism_packages.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('AsceticismLog',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('createdAt', sa.DateTime(), nullable=False),
    sa.Column('updatedAt', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['userAsceticismId'], ['UserAsceticism.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
