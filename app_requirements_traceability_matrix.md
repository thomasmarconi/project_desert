...
| :----- | :--------------- | :------------------------------------------------- | :-------- | :----- | :------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1      | Tracking         | Daily tracking of asceticism activities.           | User Req. | Done   | Highest  | Implemented with Asceticism/UserAsceticism/Log models + API.                                                                                                                        |
...
| 14     | Tracking         | Track progress against a primary vice/root sin.                                    | Suggested | To Do  | High     |                                                                                                                                                    |
| 15     | Tracking         | Implement Streak Counts and Progress Charts.                                       | Suggested | To Do  | High     |                                                                                                                                                    |
| 16     | Tracking         | Guided Daily Examination of Conscience (Examen).                                   | Suggested | To Do  | High     | Structured input/journaling feature.                                                                                                               |
| 17     | Content          | For asceticism activities allow for categories                                     | User Req. | Done   | Highest  | Implemented in Asceticism model schema.                                                                                                            |
